...
def generate_launch_description():
    ...
    # Perception node for namespace sim_69
    perception_node_sim_69 = Node(
    ...
    # Simulation node for namespace sim_69 using the YAML file
    simulation_node_sim_69 = Node(
        package='virtual_shake_robot_pybullet',
        ...
        parameters=[
            ...
            vsr_structure_path,
            pbr_structure_path,
            '/home/akshay/ros2_ws/src/virtual_shake_robot_pybullet/config/sp1_68.yaml'
        ]
    )

    control_node_sim_69 = Node(
        package='virtual_shake_robot_pybullet',
    ...
    return LaunchDescription([
        motion_mode_arg,
        GroupAction([
            PushRosNamespace('sim_69'),
            perception_node_sim_69,
            simulation_node_sim_69,
            control_node_sim_69    
        ])
    ])
