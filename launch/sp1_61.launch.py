...
def generate_launch_description():
    ...
    # Perception node for namespace sim_62
    perception_node_sim_62 = Node(
    ...
    # Simulation node for namespace sim_62 using the YAML file
    simulation_node_sim_62 = Node(
        package='virtual_shake_robot_pybullet',
        ...
        parameters=[
            ...
            vsr_structure_path,
            pbr_structure_path,
            '/home/akshay/ros2_ws/src/virtual_shake_robot_pybullet/config/sp1_61.yaml'
        ]
    )

    control_node_sim_62 = Node(
        package='virtual_shake_robot_pybullet',
    ...
    return LaunchDescription([
        motion_mode_arg,
        GroupAction([
            PushRosNamespace('sim_62'),
            perception_node_sim_62,
            simulation_node_sim_62,
            control_node_sim_62    
        ])
    ])
