...
def generate_launch_description():
    ...
    # Perception node for namespace sim_51
    perception_node_sim_51 = Node(
    ...
    # Simulation node for namespace sim_51 using the YAML file
    simulation_node_sim_51 = Node(
        package='virtual_shake_robot_pybullet',
        ...
        parameters=[
            ...
            vsr_structure_path,
            pbr_structure_path,
            '/home/akshay/ros2_ws/src/virtual_shake_robot_pybullet/config/sp1_50.yaml'
        ]
    )

    control_node_sim_51 = Node(
        package='virtual_shake_robot_pybullet',
    ...
    return LaunchDescription([
        motion_mode_arg,
        GroupAction([
            PushRosNamespace('sim_51'),
            perception_node_sim_51,
            simulation_node_sim_51,
            control_node_sim_51    
        ])
    ])
