...
def generate_launch_description():
    ...
    # Perception node for namespace sim_1
    perception_node_sim_1 = Node(
    ...
    simulation_node_sim_1 = Node(
        ...
        parameters=[
            ...
            vsr_structure_path,
            pbr_structure_path,
            '/home/akshay/ros2_ws/src/virtual_shake_robot_pybullet/config/sp1_0.yaml'
        ]
    )

    control_node_sim_1 = Node(
        package='virtual_shake_robot_pybullet',
    ...
    return LaunchDescription([
        ...
        GroupAction([
            ...
            perception_node_sim_1,
            simulation_node_sim_1,
            control_node_sim_1    
        ])
    ])
